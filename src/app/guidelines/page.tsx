...
const RULE_SECTIONS = [
  {
    ...
    rules: [
      ...
      "Members must check in at reception before every gym session or class.",
      "Only members with an active membership or valid daily pass may use the gym facilities.",
      "Members must provide membership details or identification when requested by staff.",
  ...
  },
  {
    ...
    rules: [
      "Maintain good personal hygiene and wear clean, appropriate workout clothing.",
      "Proper sports shoes must be worn in the workout area.",
      "Use a clean towel on benches, mats and other shared equipment where appropriate.",
      "Wipe down equipment after use and dispose of waste in the appropriate bins.",
      "Keep changing rooms, toilets and other shared areas clean.",
      "Spitting and other unhygienic behaviour are strictly prohibited.",
    ],
  },
  {
    icon: ShieldAlert,
    ...
    rules: [
      "Members should seek appropriate medical advice before beginning an exercise programme where necessary.",
      "Inform the trainer or management of any injury, medical limitation or condition that may affect safe exercise.",
      "Follow all safety instructions given by trainers and gym staff.",
      "Do not use equipment beyond your physical ability.",
      "Stop exercising and notify a trainer if you feel dizzy, unwell, injured or experience unusual pain.",
      "Smoking, alcohol and illegal substances are prohibited on the gym premises.",
  ...
  },
  {
    ...
    rules: [
      "Treat members, trainers and staff with courtesy and respect.",
      "Abusive language, harassment, bullying, intimidation, discrimination and fighting are not permitted.",
      "Respect other members' personal space and privacy.",
      "Do not take photographs or videos of other members without their consent.",
      "Any unlawful, threatening or inappropriate behaviour may result in suspension or termination of membership.",
    ],
  },
  {
    icon: Dumbbell,
    ...
    rules: [
      "Use all gym equipment only for its intended purpose and follow instructions.",
      "Return weights, dumbbells and other equipment to their proper positions after use.",
      "Do not drop, throw, modify, dismantle or deliberately misuse equipment.",
      "Report damaged or faulty equipment to staff immediately.",
      "Members may be responsible for damage caused by intentional misuse or negligence.",
      "Allow other members reasonable access to equipment during busy periods.",
    ],
  },
  {
    icon: Clock,
    title: "6. Punctuality",
    rules: [
      "Members are expected to arrive on time for scheduled classes.",
      "Members attending classes should arrive at least 10 minutes before the scheduled start time.",
      "Late entry may be restricted where it may affect safety or disrupt the session.",
      "Members must respect the start and end time of each class.",
    ],
  },
  {
    icon: Wallet,
    ...
    rules: [
      ...
      "Membership is activated upon confirmation of payment.",
      "Members must renew before or upon expiry to continue using the gym.",
      "Membership fees are generally non-refundable once activated, except where management approves otherwise.",
      "Daily and weekly members must pay before accessing the gym for the relevant period.",
      "Management may review prices and package terms and will communicate significant changes to members.",
    ],
  },
];
